...
// Define component
const PremiumDeveloperStatus= React.createClass({
  render() {
    ...
    return (
        <div style={paragraphStyles}>
          ...
          <div style={{marginTop: '10px', fontWeight: '400', maxWidth: '80%'}} className="badges">
            {this.props.developer.email && this.props.developer.available ? <span onClick={this.openMail} style={$.extend({}, badgeStyles, emailStyles)}>
              Email
            </span> : '' }
            {this.props.developer.data.company ? <span style={badgeStyles} className="company_shown">
              {this.props.developer.data.company}
            </span> : "" }

            {this.props.developer.available ? <span style={badgeStyles} className="available">
              Hireable
            </span> : !this.props.developer.data.company ? <span style={badgeStyles} className="may_available">
              May be hireable
            </span> : ''}
...
module.exports = PremiumDeveloperStatus;
