...
class RepoAchievement extends Component {
  constructor(props) {
    super(props);
...
RepoAchievement.propTypes = {
  relay: React.PropTypes.object,
  achievement: React.PropTypes.object,
};

const RepoAchievementContainer = Relay.createContainer(RepoAchievement, {
  fragments: {
...
export default RepoAchievementContainer;
