...
class CodeAchievement extends Component {
  constructor(props) {
    super(props);
...
CodeAchievement.propTypes = {
  relay: React.PropTypes.object,
  achievement: React.PropTypes.object,
};

const CodeAchievementContainer = Relay.createContainer(CodeAchievement, {
  fragments: {
...
export default CodeAchievementContainer;
