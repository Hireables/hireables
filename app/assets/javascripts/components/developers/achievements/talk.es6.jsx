...
class TalkAchievement extends Component {
  constructor(props) {
    super(props);
...
TalkAchievement.propTypes = {
  relay: React.PropTypes.object,
  achievement: React.PropTypes.object,
};

const TalkAchievementContainer = Relay.createContainer(TalkAchievement, {
  fragments: {
...
export default TalkAchievementContainer;
