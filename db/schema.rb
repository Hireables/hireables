...
ActiveRecord::Schema.define(version: 20161014150901) do
  ...
  create_table "recruiters", force: :cascade do |t|
    ...
    t.datetime "created_at",                             null: false
    t.datetime "updated_at",                             null: false
    t.index ["confirmation_token"], name: "index_recruiters_on_confirmation_token", unique: true, using: :btree
    ...
    t.index ["unlock_token"], name: "index_recruiters_on_unlock_token", unique: true, using: :btree
  end
